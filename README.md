...
- [ ] GAS 플러그인 활성화 (`GameplayAbilities`, `GameplayTags`, `GameplayTasks`)
- [ ] Enhanced Input 활성화 및 기본 Input Action 생성
- [ ] 멀티 접속 테스트 환경 구축(PIE 2인 이상)

### Phase 1 - 코어/캐릭터 골격

- [ ] `GameMode`, `PlayerController`, `PlayerState` 생성
- [ ] `BaseFPSCharacter` 생성 및 기본 이동/점프/시점 구현
- [ ] 1인칭 카메라 + 팔 메쉬 세팅
- [ ] 자식 캐릭터 2종(`AgentA`, `AgentB`) 생성
